...
4. **Type-Driven Development (TDD)** We're now following a recipe. We have a list of ingredients (_types_) and specific steps (_functions_) outlined. We follow the recipe step by step. The recipe tells us when to chop the onions when to add them, and when to season with peperoncino.
